...
public class BuyUpgrade : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Part == "CPU" && PC == 14)
        {
            ...
            if (Part_Upgrade == 1)
            {
                PlayerPrefs.SetInt("CPU_Upgrade_PC14_Cost", 302816);
            }
            if (Part_Upgrade == 2)
            {
            ...
            if (Part_Upgrade == 4)
            {
                PlayerPrefs.SetInt("CPU_Upgrade_PC14_Cost", 1522896);
            }
            if (Part_Upgrade == 5)
            {
                Max_Button.SetActive(true);
        ...
        if (Part == "CPU" && PC == 15)
        {
            ...
            if (Part_Upgrade == 4)
            {
                PlayerPrefs.SetInt("CPU_Upgrade_PC15_Cost", 11754560);
            }
            if (Part_Upgrade == 5)
            {
                Max_Button.SetActive(true);
        ...
        if (Part == "MotherBoard" && PC == 18)
        {
            ...
            if (Part_Upgrade < 5)
            {
                ...
                if (money >= Cost)
                {
                    ...
                    PlayerPrefs.SetFloat("profitsec", PlayerPrefs.GetFloat("profitsec") + 0.005f);
                }
                else
                {
                    SceneManager.LoadScene(scene);
        ...
        if (Part == "MotherBoard" && PC == 20)
        {
            ...
            if (Part_Upgrade < 5)
            {
                ...
                if (money >= Cost)
                {
                    ...
                    PlayerPrefs.SetFloat("profitsec", PlayerPrefs.GetFloat("profitsec") + 0.41484f);
                }
                else
                {
                    SceneManager.LoadScene(scene);
